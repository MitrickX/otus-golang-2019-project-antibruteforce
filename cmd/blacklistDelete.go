...
var blacklistDeleteCmd = &cobra.Command{
	Use:   "delete <ip> [flags]",
	Short: "Delete IP from black list",
	Long: `Delete IP from black list. 
...
`,
	...
	Run: func(cmd *cobra.Command, args []string) {
		fmt.Println("blacklistDelete called")
	},
}
...
func init() {
	...
	// blacklistDeleteCmd.PersistentFlags().String("foo", "", "A help for foo")

	// Cobra supports local flags which will only run when this command
	// is called directly, e.g.:
	// blacklistDeleteCmd.Flags().BoolP("toggle", "t", false, "Help message for toggle")
}

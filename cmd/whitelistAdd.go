...
var whitelistAddCmd = &cobra.Command{
	Use:   "add <ip> [flags]",
	Short: "Add IP into white list",
	Long: `Add IP into white list. 
...
`,
	...
	Run: func(cmd *cobra.Command, args []string) {
		fmt.Println("whitelistAdd called")
	},
}
...
func init() {
	...
	// whitelistAddCmd.PersistentFlags().String("foo", "", "A help for foo")

	// Cobra supports local flags which will only run when this command
	// is called directly, e.g.:
	// whitelistAddCmd.Flags().BoolP("toggle", "t", false, "Help message for toggle")
}
